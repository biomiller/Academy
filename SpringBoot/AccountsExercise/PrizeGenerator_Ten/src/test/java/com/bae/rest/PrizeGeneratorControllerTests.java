...
public class PrizeGeneratorControllerTests {
	...
	public void AccountNumGenTest() {
		...
		Mockito.when(service.getPrize(Constants.MOCK_ACCOUNT_NUMBER)).thenReturn("£5000 Prize.");
		
		assertEquals("£5000 Prize.", controller.getPrize(Constants.MOCK_ACCOUNT_NUMBER).getBody());
