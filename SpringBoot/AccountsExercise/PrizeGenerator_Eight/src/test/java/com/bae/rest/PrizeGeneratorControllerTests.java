...
public class PrizeGeneratorControllerTests {
	...
	public void AccountNumGenTest() {
		...
		Mockito.when(service.getPrize(Constants.MOCK_ACCOUNT_NUMBER)).thenReturn("£500 Prize.");
		
		assertEquals("£500 Prize.", controller.getPrize(Constants.MOCK_ACCOUNT_NUMBER).getBody());
